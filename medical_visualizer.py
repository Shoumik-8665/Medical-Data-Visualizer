...
def draw_cat_plot():
    ...
    # Use values from cholesterol, gluc, smoke, alco, active, and overweight
    ...
    # Show the value counts of the categorical features using seaborn's catplot()
    fig = sns.catplot(x='variable', y='total', hue='value', col='cardio', data=df_cat, kind='bar').fig

    # 8. Get the figure for the output and store it in the fig variable
    # (Already done in line above)
